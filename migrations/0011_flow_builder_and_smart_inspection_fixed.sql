-- Migration: Flow Builder and Smart Inspection System (CORRIGIDA)
-- Created: 2025-01-27
-- Description: Configuração completa do sistema de Flow Builder e Smart Inspection
-- Status: Corrigida para compatibilidade com Supabase
...
CREATE TABLE IF NOT EXISTS flow_nodes (
    ...
    plan_id TEXT NOT NULL, -- Compatível com inspection_plans
...
CREATE TABLE IF NOT EXISTS smart_inspections (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    inspection_id TEXT NOT NULL, -- Compatível com inspections
...
-- Políticas básicas para permitir acesso (configure políticas mais restritivas depois)
...
-- =====================================================
-- MIGRAÇÃO CONCLUÍDA E CORRIGIDA
-- =====================================================
-- Status: ✅ Pronta para execução no Supabase
-- Problemas corrigidos:
-- 1. ✅ Tipos UUID/TEXT compatibilizados
-- 2. ✅ Referências problemáticas removidas
-- 3. ✅ Políticas RLS simplificadas
-- 4. ✅ Sintaxe PostgreSQL corrigida
