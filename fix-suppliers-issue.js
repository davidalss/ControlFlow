    ...
    if (count.rows[0].count === '0') {
      ...
      await pool.query(`
        ...
        ('SUP001', 'Fornecedor Nacional A', 'national', 'Brasil', 'Eletrônicos', 'active', 
         ...
         4.5, 85.0, 'Fornecedor confiável', true, '00000000-0000-0000-0000-000000000001'),
        ('SUP002', 'Fornecedor Importado B', 'imported', 'China', 'Componentes', 'active',
         ...
         4.2, 78.0, 'Fornecedor internacional', true, '00000000-0000-0000-0000-000000000001')
      `);
...
async function main() {
  ...
  if (!tableExists) {
    ...
    // Aqui você pode adicionar código para criar a tabela
    return;
  }
