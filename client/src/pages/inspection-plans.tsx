...
import PlanModal from '@/components/inspection-plans/PlanModal';

export default function InspectionPlansPage() {
  const { toast } = useToast();
  const { plans, loading, error, createPlan, updatePlan, loadPlans } = useInspectionPlans();
  ...
  const handleSavePlan = async (planData: Partial<InspectionPlan>) => {
    if (modalMode === 'create') {
