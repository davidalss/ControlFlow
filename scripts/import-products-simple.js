#!/usr/bin/env node
/**
 * Script simplificado para importar produtos do arquivo Excel usando conexão direta com PostgreSQL
 */
...
const connectionString = 'postgresql://postgres.smvohmdytczfouslcaju:ExieAFZE1Xb3oyfh@aws-1-sa-east-1.pooler.supabase.com:6543/postgres';
    ...
    for (let i = 0; i < productsData.length; i++) {
        ...
        try {
            ...
            const existing = await client`
                SELECT id FROM products WHERE code = ${product.code}
            `;
            ...
            const result = await client`
                ...
                VALUES (${product.code}, ${product.ean}, ${product.description}, ${product.category}, ${product.business_unit}, ${product.technical_parameters}, NOW())
                RETURNING id
            `;
