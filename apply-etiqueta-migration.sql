-- Script para aplicar migração de etiquetas no Supabase
...
DROP TRIGGER IF EXISTS trigger_update_etiqueta_questions_updated_at ON etiqueta_questions;
...
SELECT COUNT(*) as total_etiqueta_questions FROM etiqueta_questions;
SELECT COUNT(*) as total_etiqueta_results FROM etiqueta_inspection_results;
